...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_submain_submain_component__ = __webpack_require__("../../../../../src/app/components/submain/submain.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__components_userlist_userlist_component__ = __webpack_require__("../../../../../src/app/components/userlist/userlist.component.ts");
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_9__components_submain_submain_component__["a" /* SubmainComponent */],
                __WEBPACK_IMPORTED_MODULE_13__components_userlist_userlist_component__["a" /* UserlistComponent */],
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_4__angular_router__["c" /* RouterModule */].forRoot([
                    { path: 'home', component: __WEBPACK_IMPORTED_MODULE_8__components_main_main_component__["a" /* MainComponent */] },
                    { path: 'product/:id', component: __WEBPACK_IMPORTED_MODULE_10__components_product_product_component__["a" /* ProductComponent */] },
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_11__services_user_service__["a" /* UserService */], __WEBPACK_IMPORTED_MODULE_16__services_product_service__["a" /* ProductService */], __WEBPACK_IMPORTED_MODULE_12__services_auth_service__["a" /* AuthService */]],
...
module.exports = "<div class=\"container\">\n  <h1>Login Forms</h1>\n  <form #login=\"ngForm\" (ngSubmit)=\"onLogin(login)\">\n    <div class=\"form-group\" [ngClass]=\"{'is-invalid' : showerror && !emailRef.valid}\">\n      <label for=\"exampleInputEmail1\">Email address</label>\n      <input type=\"email\" #emailRef=\"ngModel\" pattern=\"[a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,4}$\" required [(ngModel)]=\"email\" name=\"email\"\n        class=\"form-control\" id=\"exampleInputEmail1\" aria-describedby=\"emailHelp\" placeholder=\"Enter email\">\n      <small *ngIf=\"showerror && !emailRef.valid\" id=\"emailHelp\" class=\"is-invalid form-text text-muted\">Please enter valid email address</small>\n    </div>\n    <div class=\"form-group\" [ngClass]=\"{'is-invalid' : showerror && !passwordRef.valid}\">\n      <label for=\"exampleInputPassword1\">Password</label>\n      <input type=\"password\" #passwordRef=\"ngModel\" required [(ngModel)]=\"password\"\n        name=\"password\" class=\"form-control\" id=\"exampleInputPassword1\" placeholder=\"Password\">\n      <small *ngIf=\"showerror && !passwordRef.valid\" class=\"is-invalid form-text text-muted\">Your password should contain A a 1</small>\n    </div>\n    <button type=\"submit\" class=\"btn btn-primary\">Submit</button>\n  </form>\n</div>"
...
var LoginComponent = (function () {
    ...
    LoginComponent.prototype.onLogin = function (form) {
        if (form.valid) {
            this.showerror = false;
            var result = this.auth.login(form.value);
            console.log(result);
            if (result) {
...
var MainComponent = (function () {
    function MainComponent(productService) {
    ...
    MainComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.productService.get().subscribe(function (data) { _this.products = data; });
    };
...
var ProductComponent = (function () {
    ...
    ProductComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) {
            _this.productService.get().subscribe(function (data) {
                _this.product = data.find(function (product) { return product.productId == params.id; });
            });
        });
    };
...
/***/ "../../../../../src/app/components/submain/submain.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/components/submain/submain.component.html":
/***/ (function(module, exports) {
...
/***/ "../../../../../src/app/components/submain/submain.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SubmainComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var SubmainComponent = (function () {
    function SubmainComponent() {
    }
    SubmainComponent.prototype.ngOnInit = function () {
    };
    SubmainComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'app-submain',
            template: __webpack_require__("../../../../../src/app/components/submain/submain.component.html"),
            styles: [__webpack_require__("../../../../../src/app/components/submain/submain.component.css")]
        }),
        __metadata("design:paramtypes", [])
    ], SubmainComponent);
    return SubmainComponent;
}());
...
module.exports = "<ul>\n  <li *ngFor=\"let user of data\" (click)=\"selectedUser(user)\">{{user.name.first}} {{user.name.last}}</li>\n</ul>"
...
var UserlistComponent = (function () {
    ...
    UserlistComponent.prototype.selectedUser = function (user) {
    ...
    __decorate([
        ...
        __metadata("design:type", Object)
    ], UserlistComponent.prototype, "selected", void 0);
...
var AuthService = (function () {
    ...
    AuthService.prototype.login = function (formdata) {
        var selectedUser = this.users.find(function (user) { return (user.email === formdata.email) && (user.password === formdata.password); });
        if (selectedUser) {
